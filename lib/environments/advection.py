...
class AdvectionEnvironment(BaseEnvironment, ABC):
    def __init__(self,
                 ...
                 mass_cons_factor: float = 0.):
        super().__init__()
        self.dataset_name = dataset_name
        self.train = train
        self.img_size = img_size
        self.mass_cons_factor = mass_cons_factor
    ...
    def reset(self, *args, **kwargs):
        ...
        self.initial_mass = self.compute_total_mass(self.initial_condition)
    ...
    def step(self, action):
        ...
        # Extra global rewards: Global MSE & mass conservation:
        global_mass_reward = (
            (self.compute_total_mass(self.state) - self.initial_mass) ** 2
            - (self.compute_total_mass(self.rl_adjusted_state) - self.initial_mass) ** 2
        ) / self.initial_mass

        _reward += self.mass_cons_factor * global_mass_reward
